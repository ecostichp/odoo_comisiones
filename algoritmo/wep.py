...
# %%
for id in complete_df.loc[(complete_df['salesman_id'].isna()) & (complete_df['move_type'] == 'out_invoice')]['pos_line_id']:
...
# %%
for id in complete_df.loc[(complete_df['salesman_id'].isna()) & (complete_df['move_type'] == 'out_refund')]['pos_line_id']:
